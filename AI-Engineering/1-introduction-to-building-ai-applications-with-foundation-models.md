...
1. **Can a rule-based system solve it?**
   - Yes → Don't use AI
   - No → Continue evaluation

2. **Is the task creative or open-ended?**
   - Yes → Good fit for AI
   - No → Continue evaluation

3. **Do you need 100% accuracy?**
   - Yes → AI alone insufficient
   - No → Continue evaluation

4. **Is human-level performance acceptable?**
   - Yes → Consider AI
   - No → May need specialised solution

5. **Can errors be easily corrected?**
   - Yes → AI with human oversight
   - No → Consider risks carefully
